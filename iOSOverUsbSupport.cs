...
namespace MonoDevelop.Debugger.Soft.Unity
{
    ...
    static class Usbmuxd
    {
        ...
        public static bool Supported => loader != null;

        public static bool IsDllLoaded => dllHandle != IntPtr.Zero;
    ...
    static class iOSDevices
    {
        ...
        static iOSDeviceDescription[] LoadDescriptions(string path)
        {
            ...
            foreach (var line in lines)
            {
                ...
                if (!int.TryParse(cols[0], NumberStyles.HexNumber, CultureInfo.InvariantCulture, out var vendorId))
                    continue;

                if (!int.TryParse(cols[1], NumberStyles.HexNumber, CultureInfo.InvariantCulture, out var productId))
                    continue;
        ...
        static bool FindDescription(int vendorId, int productId, out iOSDeviceDescription device)
        {
        ...
        public static bool Supported => Usbmuxd.Supported;

        public static bool Initialized => Usbmuxd.IsDllLoaded || Setup();
